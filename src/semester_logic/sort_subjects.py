    ...
    for subject_code, subject_data in sorted_subjects:
        ...
        if assignments:
            for entry in assignments:
                sorted_data_list.append(
                    [
                        ...
                        f"{subject_data.get('Total Mark', 0) or 0:.2f}",  # Ensure Total Mark is not None
                    ]
                )
            ...
            totals = {
                ...
                "total_mark": subject_data.get("Total Mark", 0) or 0,  # Ensure Total Mark is not None
            ...
            sorted_data_list.append(
                [
                    ...
                    f"Total Mark: {totals['total_mark']:.2f}",
                ]
            )
